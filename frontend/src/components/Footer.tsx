    ...
    <footer className="bg-[#0a0a0a] text-white pt-16 pb-8 border-t border-white/5">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-16">
          ...
          <div>
            <h3 className="font-bold uppercase tracking-wider mb-4 text-sm">Liens utiles</h3>
            <ul className="space-y-2">
              <li><Link to="/login" className="text-zinc-400 hover:text-white transition-colors text-sm">Se connecter</Link></li>
              <li><Link to="/premium" className="text-zinc-400 hover:text-white transition-colors text-sm">Offres Premium</Link></li>
              <li><Link to="/concerts" className="text-zinc-400 hover:text-white transition-colors text-sm">Concerts</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="font-bold uppercase tracking-wider mb-4 text-sm">Découvrir</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-bold uppercase tracking-wider mb-4 text-sm">Live the Music</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-bold uppercase tracking-wider mb-4 text-sm">À propos</h3>
            <ul className="space-y-2">
           ...
           <div>
            <h3 className="font-bold uppercase tracking-wider mb-4 text-sm">Légal</h3>
             <ul className="space-y-2">
